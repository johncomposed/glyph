...
- [x] Fontations owns SFNT/TTC parsing and Skrifa owns maintained glyph bounds; fixtures cover invalid bytes, WOFF/WOFF2, required tables, AAT shaping systems, static-font axis requests, TTC face selection, and out-of-range face indexes. Variable sources pin one instance at bake time (D-371); a committed variable-font fixture and HarfBuzz oracle case for it remain open.
