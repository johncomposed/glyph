...
use pmndrs_glyph_mtsdf_core::{
    AtlasRegion, GenerateError, MtsdfGenerator, MtsdfTransform, ReadOutlineError,
};
use pmndrs_glyph_mtsdf_fontations::{font_outline_source, glyph_count};
...
fn select_font<'source>(
    ...
    (
        FontRef<'source>,
        u16,
        Option<pmndrs_glyph_raster_artifact::ResolvedRasterCoverage>,
    ),
    MtsdfBakeError,
> {
...
fn request_coverage(
    font: &FontRef<'_>,
    glyph_count: u16,
    coverage: Option<&pmndrs_glyph_raster_artifact::RasterCoverageV0>,
) -> Result<Option<pmndrs_glyph_raster_artifact::ResolvedRasterCoverage>, MtsdfBakeError> {
...
impl QuantizedGlyph {
    fn new(
        source_bounds: pmndrs_glyph_mtsdf_core::Bounds,
        units_per_em: f32,
        glyph_id: u16,
        settings: MtsdfBakeSettingsV0,
...
mod tests {
    ...
    fn bounded_descriptor_key_matches_the_typescript_contract() {
        ...
        descriptor.coverage = Some(pmndrs_glyph_raster_artifact::RasterCoverageV0 {
            unicode_ranges: Some(vec![pmndrs_glyph_raster_artifact::RasterUnicodeRangeV0 {
                start: 65,
                end: 90,
            }]),
            text: Some("AB".into()),
    ...
    fn bounded_mtsdf_rasterizes_only_selected_font_local_glyphs() {
        let coverage = pmndrs_glyph_raster_artifact::RasterCoverageV0 {
            unicode_ranges: None,
            text: None,
    ...
    fn quantized_glyph_uses_configured_scale_range_and_ceil_half_padding() {
        let bounds = pmndrs_glyph_mtsdf_core::Bounds::new(0.0, 0.0, 1000.0, 1000.0);
